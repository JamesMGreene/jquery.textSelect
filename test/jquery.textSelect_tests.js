...
module("Test jquery.textSelect via the jQuery plugin function rather than via a binding mechanism");

test("Add tests here", function() {
	ok(false, "Not implemented yet!");
});
// Test: $.textSelect with a handler will hookup event
// Test: $.textSelect without a handler will trigger event
